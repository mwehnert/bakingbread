...
export type MdxFieldsEnum = 
  ...
  | 'frontmatter___image___feature___extension'
  | 'frontmatter___image___feature___size'
  | 'frontmatter___image___feature___prettySize'
  | 'frontmatter___image___feature___modifiedTime'
  | 'frontmatter___image___feature___accessTime'
  | 'frontmatter___image___feature___changeTime'
  | 'frontmatter___image___feature___birthTime'
  | 'frontmatter___image___feature___root'
  | 'frontmatter___image___feature___dir'
  | 'frontmatter___image___feature___base'
  | 'frontmatter___image___feature___ext'
  | 'frontmatter___image___feature___name'
  | 'frontmatter___image___feature___relativeDirectory'
  | 'frontmatter___image___feature___dev'
  | 'frontmatter___image___feature___mode'
  | 'frontmatter___image___feature___nlink'
  | 'frontmatter___image___feature___uid'
  | 'frontmatter___image___feature___gid'
  | 'frontmatter___image___feature___rdev'
  | 'frontmatter___image___feature___ino'
  | 'frontmatter___image___feature___atimeMs'
  | 'frontmatter___image___feature___mtimeMs'
  | 'frontmatter___image___feature___ctimeMs'
  | 'frontmatter___image___feature___atime'
  | 'frontmatter___image___feature___mtime'
  | 'frontmatter___image___feature___ctime'
  | 'frontmatter___image___feature___birthtime'
  | 'frontmatter___image___feature___birthtimeMs'
  | 'frontmatter___image___feature___blksize'
  | 'frontmatter___image___feature___blocks'
  | 'frontmatter___image___feature___publicURL'
  | 'frontmatter___image___feature___id'
...
export type MdxFrontmatterImage = {
  ...
  creditlink?: Maybe<Scalars['String']>;
};

export type MdxFrontmatterImageFilterInput = {
  feature?: Maybe<FileFilterInput>;
  credit?: Maybe<StringQueryOperatorInput>;
  creditlink?: Maybe<StringQueryOperatorInput>;
};

export type MdxFrontmatterIngredients = {
...
export type MdxFrontmatterIngredientsFilterInput = {
  name?: Maybe<StringQueryOperatorInput>;
  amount?: Maybe<IntQueryOperatorInput>;
  unit?: Maybe<StringQueryOperatorInput>;
  step?: Maybe<IntQueryOperatorInput>;
};

export type MdxFrontmatterIngredientsFilterListInput = {
  elemMatch?: Maybe<MdxFrontmatterIngredientsFilterInput>;
};
...
export type PagesNodesQueryVariables = Exact<{ [key: string]: never; }>;


export type PagesNodesQuery = { allMdx: { edges: Array<{ node: { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<Pick<MdxFrontmatter, 'title'>> } }> } };

export type BlogDevPageQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogDevPageQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'excerpt'>
        & { fields?: Maybe<Pick<MdxFields, 'slug'>>, frontmatter?: Maybe<(
          Pick<MdxFrontmatter, 'date' | 'title' | 'dev' | 'description' | 'category' | 'tags'>
...
export type BlogPostBySlugQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, mdx?: Maybe<(
    ...
    & { frontmatter?: Maybe<(
      ...
      )>, ingredients?: Maybe<Array<Maybe<Pick<MdxFrontmatterIngredients, 'name' | 'unit' | 'amount' | 'step'>>>> }
    )> }
  )> };
